...
function MarketingCloudClient(config, options) {
  ...
  this.getOffer = request => {
    ...
    if(customerIds === void 0 && request.vars.customerId !== void 0) {
      customerIds = {
        "sympchatboxsydxd": {
          "id": request.vars.customerId,
          "authState": MarketingCloudClient.AuthState.AUTHENTICATED
        }
      }
      //customerIds = request.vars.customerId;
    }
    ...
    const targetOptions = {visitor, config, logger};
